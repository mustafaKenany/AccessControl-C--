...
public partial class AddIncomeDialog : Window
{
    ...
    private static readonly string[] FallbackEn = { "Subscription", "POS Sales", "Owner Deposit", "Other" };
    private static readonly string[] FallbackAr = { "اشتراك", "مبيعات", "إيداع المالك", "أخرى" };

    public AddIncomeDialog(ILookupService? lookupService = null)
    {
    ...
    private async void CategoryCombo_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            try { _items = await _lookupService.GetByCategoryAsync("IncomeCategory"); }
            catch { }
        }
